...
do
    ...
    do
        ...
        mpiexec -n 1 ./model data/par/sht/sht3d_s0${SEED}_p${DIM}_sz1_f150_mf13_sh2_sd52_sc_cf13_cd62.par $FLAGS
        ...
        mpiexec -n 1 ./model data/par/sht/sht3d_s0${SEED}_p${DIM}_sz1_f250_mf13_sh2_sd52_sc_cf13_cd62.par $FLAGS
...
do
    # clean up previous
    rm "sht3d_sALL_p${DIM}_f50_sh2.csv"
    rm "sht3d_sALL_p${DIM}_f150_sh2.csv"
    rm "sht3d_sALL_p${DIM}_f250_sh2.csv"
    ...
    do
        ...
        declare -a ar1=("data/res/sht/sht3d_s0${SEED}_p${DIM}_sz1_f150_mf13_sh2_sd52.csv"
                        "data/res/sht/sht3d_s0${SEED}_p${DIM}_sz1_f150_mf13_sh2_sd52_sc_cf13_cd62.csv"
        ...
        declare -a ar2=("data/res/sht/sht3d_s0${SEED}_p${DIM}_sz1_f250_mf13_sh2_sd52.csv"
                        "data/res/sht/sht3d_s0${SEED}_p${DIM}_sz1_f250_mf13_sh2_sd52_sc_cf13_cd62.csv"
        ...
        python3 tests/otherTests/merge_csv_files.py "sht3d_sALL_p${DIM}_f50_sh2.csv" "sht3d_s0${SEED}_p${DIM}_f50_sh2.csv"
        python3 tests/otherTests/merge_csv_files.py "sht3d_sALL_p${DIM}_f150_sh2.csv" "sht3d_s0${SEED}_p${DIM}_f150_sh2.csv"
        python3 tests/otherTests/merge_csv_files.py "sht3d_sALL_p${DIM}_f250_sh2.csv" "sht3d_s0${SEED}_p${DIM}_f250_sh2.csv"
    done
done
